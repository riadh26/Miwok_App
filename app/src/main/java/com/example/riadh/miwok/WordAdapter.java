...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imageCorrView = (ImageView) listItemView.findViewById(R.id.image_corr_view);
        if (currentWord.hasImage())
            imageCorrView.setImageResource(currentWord.getImageRessorceId());
        else
            imageCorrView.setVisibility(View.GONE);
